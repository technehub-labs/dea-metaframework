...
| [`schemas/`](./schemas) | JSON Schemas: canonical business object / capability map / lifecycle traceability (`entity.schema.json`, `capability.schema.json`, `traceability.schema.json`; predate CR-ECF-005); canonical ECF Domain, Stage, and Coordinate schemas under the new specification (`ecf-domain.schema.json`, `ecf-stage.schema.json`, `ecf-coordinate.schema.json`, CR-ECF-005). |
| [`specification/`](./specification) | Normative specifications (CR-ECF-005 onwards): the canonical ECF Coordinate specification. |
